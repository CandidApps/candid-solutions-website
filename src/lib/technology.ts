export const technology = {
  hero: {
    ...
    ghost: { href: "#work", label: "See the work we take on" },
  ...
  staff: {
    ...
    lead: "These are Candid engagements. We quote them, we finish them, and you call the same team when something changes.",
    items: [
      {
        kicker: "IT portfolio",
      ...
      },
      {
        ...
        body: "Infrastructure, SaaS, and colocation. We run the selection and the cutover.",
      },
      {
        kicker: "Security",
        title: "Close the gaps",
        body: "Assessment, access, and the products that fix what you found. One Candid relationship from the finding to the fix.",
      },
      {
  ...
  network: {
    label: "The network",
    title: "Quoted here. Finished here.",
